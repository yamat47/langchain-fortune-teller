...
class FortuneTeller
  ...
  PROMPT = <<~PROMPT
    ...
    元々のテキストと、サービスの情報とをしっかり組み合わせてほしいです。
    無理矢理でいいので、こじつけでいいので、ユーザーからの問いかけをなんとか結びつけて表現してください。
    全体で5文くらいの長さにしてください。長い返信が望まれます。
    ...
    ユーザーの気持ちに共感しながら、「一緒に良い方向に向かっていきましょう」という気持ちで接してください。
  PROMPT
